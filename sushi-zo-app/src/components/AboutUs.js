    ...
    <div className="about-us" id="aboutUsJump">
      ...
      <div className="about-us-text">
        ...
        <div className="text" id="aboutPart1">
          <p>Sushi Zo is created "Ittai-ken"-style. Ittai-jan is when the neta (the seafood) and shari (sushi rice) unite in perfect harmony.   
          <br />
          <br />
          This balance is the most important aspect of sushi.
          </p>
        </div>
        <div className="text" id="aboutPart2">
          <p>Our rice is meticulously cooked, seasoned with a unique blend of vinegars and served at body temperature, to create the perfect  partner to the "neta".
            <br />
            <br />
